...
/**
 * 关闭订单参数对象 <br>
 * @see <a href="https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_3">https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_3</a>
 * Created by HanleyTang on 2017/3/15.
 */
