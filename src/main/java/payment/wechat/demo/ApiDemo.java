package payment.wechat.demo;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import payment.wechat.entity.input.*;
import payment.wechat.entity.output.*;
import payment.wechat.portal.client.WechatClient;
import payment.wechat.utils.DataUtil;
import payment.wechat.utils.DateUtil;
import payment.wechat.utils.LocalUtil;
import payment.wechat.utils.ZxingUtil;
...
public class ApiDemo {
    ...
    private static final String hanley_wechat_openid = "o2nMlwuj_cHFBcNDfPkpufta80KU";
    	...
    	static String p12FilePath = "/zone/p12/1386246702.p12";
...
//        test_QueryMicroMch();
    ...
    public static  void testRefund(){
        ...
        data.setAppid(igo_wechat_appid);
        data.setMch_id(igo_wechat_mchid);
        ...
        WechatRefundOutput output = WechatClient.refund(data,igo_wechat_apikey,p12FilePath);
